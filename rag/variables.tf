...
variable "frontend_image" {
  type        = string
  description = "Docker image for the RAG frontend. Defaults to the published image; to use your own, build from rag/frontend/container/, push it to your registry, and set this to the pushed digest."
